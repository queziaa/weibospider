...
class TweetSpiderByKeyword(Spider):
    ...
    def start_requests(self):
        ...
        end_time = datetime.datetime(year=int(s['end_time'][0:4]), month=int(s['end_time'][4:6]), day=int(s['end_time'][6:8]), hour=int(s['end_time'][8:10]))
        start_time = datetime.datetime(year=int(s['start_time'][0:4]), month=int(s['start_time'][4:6]), day=int(s['start_time'][6:8]), hour=int(s['start_time'][8:10]))
